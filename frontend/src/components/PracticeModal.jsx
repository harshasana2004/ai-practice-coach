...
// A simple spinner SVG component for the loading indicator
const Spinner = () => (
  <svg className="animate-spin" style={{ marginRight: '0.75rem', height: '1.25rem', width: '1.25rem', color: '#4f46e5' }} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
